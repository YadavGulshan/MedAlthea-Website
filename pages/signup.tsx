        ...
        <div className="my-2 mx-auto flex h-full w-full max-w-6xl flex-col items-center justify-center px-4 md:w-3/4">
          <div className="mx-10 w-full sm:w-[448px]">
            ...
            <form className="">
              ...
              <div>
                <input
                  className="my-4 h-14 w-full rounded-full border-2 border-none bg-blue-500 px-6 font-bold text-white outline-none transition duration-300 hover:border-blue-300 hover:shadow-xl hover:shadow-blue-400 md:px-10"
                  type="submit"
                  value="Log in"
                />
              </div>
              <div className="my-5 flex flex-col items-center justify-evenly font-Inter font-semibold sm:flex-row">
                <p>Not have an account yet?</p>
                <Link
                  underline="none"
                  className="my-2 rounded-md bg-blue-500 py-2 px-4 font-bold text-white shadow-xl shadow-blue-400"
                  href="/register"
                >
                  Register now
                </Link>
